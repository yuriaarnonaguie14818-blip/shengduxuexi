...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        # Expand dense_prompt_embeddings similarly
        dense_prompt_embeddings = dense_prompt_embeddings.repeat_interleave(tokens.shape[0] // dense_prompt_embeddings.shape[0], dim=0)
        src = src + dense_prompt_embeddings
        # pos_src = torch.repeat_interleave(image_pe, tokens.shape[0], dim=0)
        b, c, h, w = src.shape
